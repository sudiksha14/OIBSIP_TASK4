...
public class QuestionActivity extends AppCompatActivity {
    ...
    String answers[] = {"Guido van Rossum","all of the mentioned","no",".py","Python code is neither compiled nor interpreted","None of the mentioned","Indentation","Def","#","lambda"};
    String opt[] = {
